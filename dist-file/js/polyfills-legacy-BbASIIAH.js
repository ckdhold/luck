(function () {
	...
	var toIndexedObject$h = function (it) {
	  return IndexedObject$6(requireObjectCoercible$g(it));
	};
	...
	var $String$8 = globalThis$11.String;

	// eslint-disable-next-line es/no-object-getownpropertysymbols -- required for testing
	var symbolConstructorDetection = !!Object.getOwnPropertySymbols && !fails$1c(function () {
	...
	var ordinaryToPrimitive$2 = function (input, pref) {
	  var fn, val;
	  if (pref === 'string' && isCallable$u(fn = input.toString) && !isObject$y(val = call$I(fn, input))) return val;
	  if (isCallable$u(fn = input.valueOf) && !isObject$y(val = call$I(fn, input))) return val;
	  if (pref !== 'string' && isCallable$u(fn = input.toString) && !isObject$y(val = call$I(fn, input))) return val;
	...
	var hasOwnProperty = uncurryThis$19({}.hasOwnProperty);
	...
	var wellKnownSymbol$z = function (name) {
	  if (!hasOwn$x(WellKnownSymbolsStore$1, name)) {
	    WellKnownSymbolsStore$1[name] = NATIVE_SYMBOL$6 && hasOwn$x(Symbol$3, name)
	      ? Symbol$3[name]
	...
	objectGetOwnPropertyDescriptor.f = DESCRIPTORS$E ? $getOwnPropertyDescriptor$2 : function getOwnPropertyDescriptor(O, P) {
	  ...
	  if (hasOwn$w(O, P)) return createPropertyDescriptor$b(!call$G(propertyIsEnumerableModule$2.f, O, P), O[P]);
	};
	...
	var anObject$I = function (argument) {
	  ...
	  throw new $TypeError$o($String$6(argument) + ' is not an object');
	};
	...
	var createNonEnumerableProperty$g = DESCRIPTORS$B ? function (object, key, value) {
	  return definePropertyModule$8.f(object, key, createPropertyDescriptor$a(1, value));
	...
	var EXISTS = hasOwn$v(FunctionPrototype$2, 'name');
	...
	var replace$c = uncurryThis$16(''.replace);
	var join$6 = uncurryThis$16([].join);

	var CONFIGURABLE_LENGTH = DESCRIPTORS$z && !fails$19(function () {
	...
	var makeBuiltIn$2 = makeBuiltIn$3.exports = function (value, name, options) {
	  ...
	  try {
	    if (options && hasOwn$t(options, 'constructor') && options.constructor) {
	      if (DESCRIPTORS$z) defineProperty$c(value, 'prototype', { writable: false });
	...
	var defineBuiltIn$l = function (O, key, value, options) {
	  ...
	  if (isCallable$q(value)) makeBuiltIn$1(value, name, options);
	  if (options.global) {
	...
	var toIntegerOrInfinity$k = function (argument) {
	  var number = +argument;
	  // eslint-disable-next-line no-self-compare -- NaN check
	  return number !== number || number === 0 ? 0 : trunc$1(number);
	};

	var toIntegerOrInfinity$j = toIntegerOrInfinity$k;
	...
	var toAbsoluteIndex$8 = function (index, length) {
	  var integer = toIntegerOrInfinity$j(index);
	  return integer < 0 ? max$6(integer + length, 0) : min$a(integer, length);
	};

	var toIntegerOrInfinity$i = toIntegerOrInfinity$k;
	...
	var toLength$b = function (argument) {
	  var len = toIntegerOrInfinity$i(argument);
	...
	var push$g = uncurryThis$15([].push);
	...
	var objectKeysInternal = function (object, names) {
	  ...
	  while (names.length > i) if (hasOwn$s(O, key = names[i++])) {
	    ~indexOf$2(result, key) || push$g(result, key);
	  }
	  return result;
	};
	...
	var isForced$5 = function (feature, detection) {
	  ...
	  return value === POLYFILL ? true
	    : value === NATIVE ? false
	    : isCallable$p(detection) ? fails$18(detection)
	    : !!detection;
	};
	...
	*/
	...
	var arraySlice$a = uncurryThis$13([].slice);
	...
	var functionUncurryThisClause = function (fn) {
	  ...
	  if (classofRaw(fn) === 'Function') return uncurryThis$12(fn);
	};
	...
	var bind$e = uncurryThis$11(uncurryThis$11.bind);
	...
	var exec$a = uncurryThis$10(constructorRegExp.exec);
	...
	var isConstructor$5 = !construct$1 || fails$17(function () {
	  var called;
	...
	var arraySpeciesConstructor$1 = function (originalArray) {
	  ...
	  if (isArray$7(originalArray)) {
	    ...
	    if (isConstructor$4(C) && (C === $Array$7 || isArray$7(C.prototype))) C = undefined;
	...
	var createMethod$6 = function (TYPE) {
	  ...
	  return function ($this, callbackfn, that, specificCreate) {
	    ...
	    var length = lengthOfArrayLike$r(self);
	...
	var setSymbolDescriptor = DESCRIPTORS$x && fails$16(function () {
	...
	var $defineProperty = function defineProperty(O, P, Attributes) {
	  ...
	  if (hasOwn$o(AllSymbols, key)) {
	    if (!Attributes.enumerable) {
	      if (!hasOwn$o(O, HIDDEN)) nativeDefineProperty$1(O, HIDDEN, createPropertyDescriptor$9(1, nativeObjectCreate(null)));
	      O[HIDDEN][key] = true;
	    } else {
	...
	var $defineProperties = function defineProperties(O, Properties) {
	  ...
	  $forEach$2(keys, function (key) {
	    if (!DESCRIPTORS$x || call$E($propertyIsEnumerable$1, properties, key)) $defineProperty(O, key, properties[key]);
	  });
	  return O;
	};
	...
	if (!NATIVE_SYMBOL$5) {
	  $Symbol = function Symbol() {
	    ...
	    var setter = function (value) {
	      ...
	      if ($this === ObjectPrototype$4) call$E(setter, ObjectPrototypeSymbols, value);
	...
	$$20({ global: true, constructor: true, wrap: true, forced: !NATIVE_SYMBOL$5, sham: !NATIVE_SYMBOL$5 }, {
	  Symbol: $Symbol
	});
	...
	$$20({ target: SYMBOL, stat: true, forced: !NATIVE_SYMBOL$5 }, {
	  useSetter: function () { USE_SETTER = true; },
	  useSimple: function () { USE_SETTER = false; }
	});

	$$20({ target: 'Object', stat: true, forced: !NATIVE_SYMBOL$5, sham: !DESCRIPTORS$x }, {
	  // `Object.create` method
	  // https://tc39.es/ecma262/#sec-object.create
	  create: $create,
	  // `Object.defineProperty` method
	...
	$$20({ target: 'Object', stat: true, forced: !NATIVE_SYMBOL$5 }, {
	  // `Object.getOwnPropertyNames` method
	  // https://tc39.es/ecma262/#sec-object.getownpropertynames
	...
	$$1$({ target: 'Symbol', stat: true, forced: !NATIVE_SYMBOL_REGISTRY$1 }, {
	  'for': function (key) {
	...
	$$1_({ target: 'Symbol', stat: true, forced: !NATIVE_SYMBOL_REGISTRY }, {
	...
	var functionApply$1 = typeof Reflect == 'object' && Reflect.apply || (NATIVE_BIND$1 ? call$D.bind(apply$9) : function () {
	  return call$D.apply(apply$9, arguments);
	});
	...
	var getJsonReplacerFunction = function (replacer) {
	  ...
	  for (var i = 0; i < rawLength; i++) {
	    ...
	    else if (typeof element == 'number' || classof$g(element) === 'Number' || classof$g(element) === 'String') push$d(keys, toString$t(element));
	  }
	...
	var exec$9 = uncurryThis$Y(/./.exec);
	var charAt$c = uncurryThis$Y(''.charAt);
	var charCodeAt$4 = uncurryThis$Y(''.charCodeAt);
	var replace$b = uncurryThis$Y(''.replace);
	...
	var WRONG_SYMBOLS_CONVERSION = !NATIVE_SYMBOL$3 || fails$15(function () {
	...
	var ILL_FORMED_UNICODE = fails$15(function () {
	  return $stringify('\uDF06\uD834') !== '"\\udf06\\ud834"'
	    || $stringify('\uDEAD') !== '"\\udead"';
	});
	...
	var stringifyWithSymbolsFix = function (it, replacer) {
	  ...
	  args[1] = function (key, value) {
	    ...
	    if (isCallable$l($replacer)) value = call$C($replacer, this, $String$3(key), value);
	...
	if ($stringify) {
	  ...
	  $$1Z({ target: 'JSON', stat: true, arity: 3, forced: WRONG_SYMBOLS_CONVERSION || ILL_FORMED_UNICODE }, {
	    // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	var FORCED$m = !NATIVE_SYMBOL$2 || fails$14(function () { getOwnPropertySymbolsModule$1.f(1); });

	// `Object.getOwnPropertySymbols` method
	// https://tc39.es/ecma262/#sec-object.getownpropertysymbols
	$$1Y({ target: 'Object', stat: true, forced: FORCED$m }, {
	...
	if (DESCRIPTORS$w && isCallable$k(NativeSymbol) && (!('description' in SymbolPrototype) ||
	  // Safari 12 bug
	  ...
	  var SymbolWrapper = function Symbol() {
	    var description = arguments.length < 1 || arguments[0] === undefined ? undefined : toString$s(arguments[0]);
	  ...
	  defineBuiltInAccessor$g(SymbolPrototype, 'description', {
	    ...
	    get: function description() {
	      ...
	      var desc = NATIVE_SYMBOL$1 ? stringSlice$e(string, 7, -1) : replace$a(string, regexp, '$1');
	...
	var functionUncurryThisAccessor = function (object, key, method) {
	  try {
	    // eslint-disable-next-line es/no-object-getownpropertydescriptor -- safe
	    return uncurryThis$W(aCallable$n(Object.getOwnPropertyDescriptor(object, key)[method]));
	  } catch (error) { /* empty */ }
	};
	...
	var aPossiblePrototype$1 = function (argument) {
	  ...
	  throw new $TypeError$m("Can't set " + $String$2(argument) + ' as a prototype');
	};
	...
	var normalizeStringArgument$5 = function (argument, $default) {
	  return argument === undefined ? arguments.length < 2 ? '' : $default : toString$r(argument);
	};
	...
	var $Error$1 = Error;
	var replace$9 = uncurryThis$V(''.replace);
	...
	var FORCED$l = new Error('e', { cause: 7 }).cause !== 7;

	var exportGlobalErrorCauseWrapper = function (ERROR_NAME, wrapper) {
	  var O = {};
	  O[ERROR_NAME] = wrapErrorConstructorWithCause(ERROR_NAME, wrapper, FORCED$l);
	  $$1W({ global: true, constructor: true, arity: 1, forced: FORCED$l }, O);
	};

	var exportWebAssemblyErrorCauseWrapper = function (ERROR_NAME, wrapper) {
	  if (WebAssembly && WebAssembly[ERROR_NAME]) {
	    var O = {};
	    O[ERROR_NAME] = wrapErrorConstructorWithCause(WEB_ASSEMBLY + '.' + ERROR_NAME, wrapper, FORCED$l);
	    $$1W({ target: WEB_ASSEMBLY, stat: true, constructor: true, arity: 1, forced: FORCED$l }, O);
	  }
	};
	...
	var addToUnscopables$c = function (key) {
	...
	var toIntegerOrInfinity$h = toIntegerOrInfinity$k;
	var addToUnscopables$b = addToUnscopables$c;
	...
	var createProperty$8 = function (object, key, value) {
	  if (DESCRIPTORS$u) definePropertyModule$3.f(object, key, createPropertyDescriptor$7(0, value));
	...
	$$1U({ target: 'Array', proto: true, arity: 1, forced: FORCED$k }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	var addToUnscopables$a = addToUnscopables$c;
	...
	$$1S({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT$3 }, {
	...
	var addToUnscopables$9 = addToUnscopables$c;
	...
	// `Array.prototype.find` method
	// https://tc39.es/ecma262/#sec-array.prototype.find
	$$1R({ target: 'Array', proto: true, forced: SKIPS_HOLES$1 }, {
	...
	var addToUnscopables$8 = addToUnscopables$c;
	...
	// `Array.prototype.findIndex` method
	// https://tc39.es/ecma262/#sec-array.prototype.findindex
	$$1Q({ target: 'Array', proto: true, forced: SKIPS_HOLES }, {
	...
	var toIntegerOrInfinity$g = toIntegerOrInfinity$k;
	...
	$$1P({ target: 'Array', proto: true }, {
	  flat: function flat(/* depthArg = 1 */) {
	    ...
	    A.length = flattenIntoArray$1(A, O, O, sourceLen, 0, depthArg === undefined ? 1 : toIntegerOrInfinity$g(depthArg));
	    return A;
	  }
	});
	...
	var ITERATOR$b = wellKnownSymbol$n('iterator');
	...
	var ITERATOR$a = wellKnownSymbol$m('iterator');

	var getIteratorMethod$6 = function (it) {
	  if (!isNullOrUndefined$a(it)) return getMethod$6(it, ITERATOR$a)
	...
	var getIterator$4 = function (argument, usingIterator) {
	  ...
	  if (aCallable$l(iteratorMethod)) return anObject$A(call$A(iteratorMethod, argument));
	...
	// `Array.from` method
	// https://tc39.es/ecma262/#sec-array.from
	$$1N({ target: 'Array', stat: true, forced: INCORRECT_ITERATION }, {
	  from: from
	});
	...
	var addToUnscopables$7 = addToUnscopables$c;
	...
	// `Array.prototype.includes` method
	// https://tc39.es/ecma262/#sec-array.prototype.includes
	$$1M({ target: 'Array', proto: true, forced: BROKEN_ON_SPARSE }, {
	...
	var NEW_ITERATOR_PROTOTYPE = !isObject$n(IteratorPrototype$4) || fails$_(function () {
	  var test = {};
	...
	if (!isCallable$h(IteratorPrototype$4[ITERATOR$8])) {
	  defineBuiltIn$h(IteratorPrototype$4, ITERATOR$8, function () {
	    return this;
	  });
	}
	...
	var iteratorCreateConstructor = function (IteratorConstructor, NAME, next, ENUMERABLE_NEXT) {
	  ...
	  IteratorConstructor.prototype = create$9(IteratorPrototype$3, { next: createPropertyDescriptor$6(+!ENUMERABLE_NEXT, next) });
	...
	var iteratorDefine = function (Iterable, NAME, IteratorConstructor, next, DEFAULT, IS_SET, FORCED) {
	  ...
	  if (DEFAULT) {
	    ...
	    } else $$1L({ target: NAME, proto: true, forced: BUGGY_SAFARI_ITERATORS || INCORRECT_VALUES_NAME }, methods);
	  }
	...
	var addToUnscopables$6 = addToUnscopables$c;
	...
	var FORCED$j = ES3_STRINGS || !arrayMethodIsStrict$3('join', ',');

	// `Array.prototype.join` method
	// https://tc39.es/ecma262/#sec-array.prototype.join
	$$1K({ target: 'Array', proto: true, forced: FORCED$j }, {
	  join: function join(separator) {
	    return nativeJoin(toIndexedObject$9(this), separator === undefined ? ',' : separator);
	  }
	});
	...
	var FORCED$i = INCORRECT_TO_LENGTH || !properErrorOnNonWritableLength$1();

	// `Array.prototype.push` method
	// https://tc39.es/ecma262/#sec-array.prototype.push
	$$1I({ target: 'Array', proto: true, arity: 1, forced: FORCED$i }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	var deletePropertyOrThrow$4 = function (O, P) {
	  if (!delete O[P]) throw new $TypeError$i('Cannot delete property ' + tryToString$3(P) + ' of ' + tryToString$3(O));
	};
	...
	var push$c = uncurryThis$T(test.push);
	...
	var FORCED$h = FAILS_ON_UNDEFINED || !FAILS_ON_NULL || !STRICT_METHOD$2 || !STABLE_SORT$1;
	...
	$$1G({ target: 'Array', proto: true, forced: FORCED$h }, {
	...
	var toIntegerOrInfinity$f = toIntegerOrInfinity$k;
	...
	// with adding support of @@species
	$$1F({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT }, {
	  splice: function splice(start, deleteCount /* , ...items */) {
	    ...
	    if (argumentsLength === 0) {
	      ...
	      actualDeleteCount = min$8(max$4(toIntegerOrInfinity$f(deleteCount), 0), len - actualStart);
	    }
	...
	var addToUnscopables$5 = addToUnscopables$c;
	...
	$$1E({ target: 'Array', proto: true }, {
	  toReversed: function toReversed() {
	    return arrayToReversed$1(toIndexedObject$7(this), $Array$4);
	  }
	});

	addToUnscopables$5('toReversed');

	var lengthOfArrayLike$e = lengthOfArrayLike$t;

	var arrayFromConstructorAndList$5 = function (Constructor, list, $length) {
	  var index = 0;
	  var length = arguments.length > 2 ? $length : lengthOfArrayLike$e(list);
	...
	var getBuiltInPrototypeMethod$1 = function (CONSTRUCTOR, METHOD) {
	  var Constructor = globalThis$R[CONSTRUCTOR];
	...
	var addToUnscopables$4 = addToUnscopables$c;

	var $Array$3 = Array;
	var sort$1 = uncurryThis$S(getBuiltInPrototypeMethod('Array', 'sort'));
	...
	$$1D({ target: 'Array', proto: true }, {
	  toSorted: function toSorted(compareFn) {
	    ...
	    var A = arrayFromConstructorAndList$4($Array$3, O);
	    return sort$1(A, compareFn);
	  }
	});

	addToUnscopables$4('toSorted');

	var $$1C = _export;
	var addToUnscopables$3 = addToUnscopables$c;
	...
	var toIntegerOrInfinity$e = toIntegerOrInfinity$k;
	...
	$$1C({ target: 'Array', proto: true }, {
	  toSpliced: function toSpliced(start, deleteCount /* , ...items */) {
	    ...
	    if (argumentsLength === 0) {
	      ...
	      insertCount = argumentsLength - 2;
	      actualDeleteCount = min$7(max$3(toIntegerOrInfinity$e(deleteCount), 0), len - actualStart);
	    }
	...
	addToUnscopables$3('toSpliced');

	// this method was added to unscopables after implementation
	// in popular engines, so it's moved to a separate module
	var addToUnscopables$2 = addToUnscopables$c;
	...
	// this method was added to unscopables after implementation
	// in popular engines, so it's moved to a separate module
	var addToUnscopables$1 = addToUnscopables$c;
	...
	$$1B({ target: 'Array', proto: true, arity: 1, forced: FORCED$g }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	var toIntegerOrInfinity$d = toIntegerOrInfinity$k;
	...
	var pack = function (number, mantissaLength, bytes) {
	  ...
	  if (number !== number || number === Infinity) {
	    ...
	    exponent = floor$7(log$3(number) / LN2$1);
	    c = pow$3(2, -exponent);
	    if (number * c < 1) {
	      exponent--;
	      c *= 2;
	...
	var unpack = function (buffer, mantissaLength) {
	  ...
	  if (exponent === 0) {
	    ...
	    mantissa += pow$3(2, mantissaLength);
	    exponent -= eBias;
	...
	var toIntegerOrInfinity$c = toIntegerOrInfinity$k;
	...
	if (!NATIVE_ARRAY_BUFFER$1) {
	  ...
	  if (!fails$W(function () {
	    ...
	    createNonEnumerableProperty$9(NativeArrayBuffer$1, 'name', ARRAY_BUFFER$1);
	  }
	...
	$$1A({ global: true, constructor: true, forced: NativeArrayBuffer !== ArrayBuffer$6 }, {
	...
	var ArrayBuffer$5 = globalThis$O.ArrayBuffer;
	...
	var slice$5 = ArrayBufferPrototype$3 && uncurryThis$Q(ArrayBufferPrototype$3.slice);
	...
	var environment = (function () {
	  ...
	  if (classof$d(globalThis$M.process) === 'process') return 'NODE';
	...
	var slice$4 = uncurryThis$P(ArrayBufferPrototype$1.slice);
	...
	var getInt8 = uncurryThis$P(DataViewPrototype.getInt8);
	...
	if ($transfer$1) $$1z({ target: 'ArrayBuffer', proto: true }, {
	...
	if ($transfer) $$1y({ target: 'ArrayBuffer', proto: true }, {
	...
	if (DESCRIPTORS$o && !FUNCTION_NAME_EXISTS) {
	...
	var dateToPrimitive$1 = function (hint) {
	  ...
	  else if (hint !== 'number') throw new $TypeError$f('Incorrect hint');
	...
	$$1x({ global: true, forced: globalThis$H.globalThis !== globalThis$H }, {
	...
	var FAILS_ON_PRIMITIVES$6 = fails$T(function () { $isExtensible$1(1); });
	...
	var enable = function () {
	  ...
	  if (getOwnPropertyNames(test).length) {
	    ...
	    $$1w({ target: 'Object', stat: true, forced: true }, {
	...
	var collection$4 = function (CONSTRUCTOR_NAME, wrapper, common) {
	  ...
	  var REPLACE = isForced$3(
	    CONSTRUCTOR_NAME,
	    !isCallable$f(NativeConstructor) || !(IS_WEAK || NativePrototype.forEach && !fails$R(function () {
	  ...
	  if (REPLACE) {
	    ...
	    if (!ACCEPT_ITERABLES) {
	      Constructor = wrapper(function (dummy, iterable) {
	        ...
	        if (!isNullOrUndefined$9(iterable)) iterate$e(iterable, that[ADDER], { that: that, AS_ENTRIES: IS_MAP });
	        return that;
	      });
	  ...
	  $$1v({ global: true, constructor: true, forced: Constructor !== NativeConstructor }, exported);
	...
	var collectionStrong$2 = {
	  getConstructor: function (wrapper, CONSTRUCTOR_NAME, IS_MAP, ADDER) {
	    var Constructor = wrapper(function (that, iterable) {
	      ...
	      if (!isNullOrUndefined$8(iterable)) iterate$d(iterable, that[ADDER], { that: that, AS_ENTRIES: IS_MAP });
	    });
	    ...
	    if (DESCRIPTORS$n) defineBuiltInAccessor$b(Prototype, 'size', {
	      configurable: true,
	      get: function () {
	...
	$$1u({ target: 'Math', stat: true, forced: FORCED$f }, {
	...
	var thisNumberValue$4 = uncurryThis$L(1.0.valueOf);
	...
	var createMethod$5 = function (TYPE) {
	  return function ($this) {
	    var string = toString$p(requireObjectCoercible$d($this));
	...
	var stringSlice$d = uncurryThis$J(''.slice);
	...
	var FORCED$e = isForced$2(NUMBER, !NativeNumber(' 0o1') || !NativeNumber('0b1') || NativeNumber('+0x1'));

	var calledWithNew = function (dummy) {
	  // includes check on 1..constructor(foo) case
	  return isPrototypeOf$5(NumberPrototype, dummy) && fails$P(function () { thisNumberValue$3(dummy); });
	};
	...
	if (FORCED$e && !IS_PURE$5) NumberPrototype.constructor = NumberWrapper;

	$$1q({ global: true, constructor: true, wrap: true, forced: FORCED$e }, {
	  Number: NumberWrapper
	});

	// Use `internal/copy-constructor-properties` helper in `core-js@4`
	var copyConstructorProperties$1 = function (target, source) {
	  for (var keys = DESCRIPTORS$m ? getOwnPropertyNames$3(source) : (
	    // ES3:
	...
	if (FORCED$e || IS_PURE$5) copyConstructorProperties$1(path[NUMBER], NativeNumber);
	...
	var $parseFloat = globalThis$D.parseFloat;
	var Symbol$2 = globalThis$D.Symbol;
	var ITERATOR$6 = Symbol$2 && Symbol$2.iterator;
	var FORCED$d = 1 / $parseFloat(whitespaces$3 + '-0') !== -Infinity
	  // MS Edge 18- broken with boxed symbols
	  || (ITERATOR$6 && !fails$O(function () { $parseFloat(Object(ITERATOR$6)); }));
	...
	$$1m({ target: 'Number', stat: true, forced: Number.parseFloat !== parseFloat }, {
	...
	var $parseInt$2 = globalThis$C.parseInt;
	var Symbol$1 = globalThis$C.Symbol;
	var ITERATOR$5 = Symbol$1 && Symbol$1.iterator;
	var hex = /^[+-]?0x/i;
	var exec$8 = uncurryThis$H(hex.exec);
	var FORCED$c = $parseInt$2(whitespaces$2 + '08') !== 8 || $parseInt$2(whitespaces$2 + '0x16') !== 22
	  // MS Edge 18- broken with boxed symbols
	  || (ITERATOR$5 && !fails$N(function () { $parseInt$2(Object(ITERATOR$5)); }));
	...
	$$1l({ target: 'Number', stat: true, forced: Number.parseInt !== parseInt$2 }, {
	  parseInt: parseInt$2
	});

	var toIntegerOrInfinity$b = toIntegerOrInfinity$k;
	...
	var stringRepeat = function repeat(count) {
	  var str = toString$m(requireObjectCoercible$c(this));
	  var result = '';
	...
	var toIntegerOrInfinity$a = toIntegerOrInfinity$k;
	...
	var repeat$3 = uncurryThis$G($repeat$2);
	var stringSlice$c = uncurryThis$G(''.slice);
	var nativeToFixed = uncurryThis$G(1.0.toFixed);
	...
	$$1k({ target: 'Number', proto: true, forced: FORCED$b }, {
	...
	var objectAssign = !$assign || fails$L(function () {
	  ...
	  if (DESCRIPTORS$l && $assign({ b: 1 }, $assign(defineProperty$3({}, 'a', {
	    enumerable: true,
	    get: function () {
	  ...
	  while (argumentsLength > index) {
	    ...
	    while (length > j) {
	      key = keys[j++];
	      if (!DESCRIPTORS$l || call$w(propertyIsEnumerable, S, key)) T[key] = S[key];
	    }
	  } return T;
	} : $assign;
	...
	var IE_BUG = DESCRIPTORS$k && fails$K(function () {
	  // eslint-disable-next-line es/no-object-create -- safe
	  ...
	  return function (it) {
	    ...
	    while (length > i) {
	      ...
	      if (!DESCRIPTORS$k || (IE_WORKAROUND ? key in O : propertyIsEnumerable(O, key))) {
	        push$b(result, TO_ENTRIES ? [key, O[key]] : O[key]);
	      }
	    }
	    return result;
	  };
	...
	var FAILS_ON_PRIMITIVES$5 = fails$J(function () { $freeze(1); });

	// `Object.freeze` method
	// https://tc39.es/ecma262/#sec-object.freeze
	$$1h({ target: 'Object', stat: true, forced: FAILS_ON_PRIMITIVES$5, sham: !FREEZING$3 }, {
	...
	var FORCED$a = !DESCRIPTORS$j || fails$I(function () { nativeGetOwnPropertyDescriptor$1(1); });

	// `Object.getOwnPropertyDescriptor` method
	// https://tc39.es/ecma262/#sec-object.getownpropertydescriptor
	$$1g({ target: 'Object', stat: true, forced: FORCED$a, sham: !DESCRIPTORS$j }, {
	...
	// https://tc39.es/ecma262/#sec-object.getownpropertydescriptors
	$$1f({ target: 'Object', stat: true, sham: !DESCRIPTORS$i }, {
	...
	var FAILS_ON_PRIMITIVES$4 = fails$H(function () { return !Object.getOwnPropertyNames(1); });

	// `Object.getOwnPropertyNames` method
	// https://tc39.es/ecma262/#sec-object.getownpropertynames
	$$1e({ target: 'Object', stat: true, forced: FAILS_ON_PRIMITIVES$4 }, {
	...
	var FAILS_ON_PRIMITIVES$3 = fails$G(function () { nativeGetPrototypeOf(1); });

	// `Object.getPrototypeOf` method
	// https://tc39.es/ecma262/#sec-object.getprototypeof
	$$1d({ target: 'Object', stat: true, forced: FAILS_ON_PRIMITIVES$3, sham: !CORRECT_PROTOTYPE_GETTER$1 }, {
	...
	// https://tc39.es/ecma262/#sec-object.isextensible
	// eslint-disable-next-line es/no-object-isextensible -- safe
	$$1b({ target: 'Object', stat: true, forced: Object.isExtensible !== $isExtensible }, {
	...
	var FORCED$9 = ARRAY_BUFFER_NON_EXTENSIBLE || fails$F(function () { $isFrozen(1); });

	// `Object.isFrozen` method
	// https://tc39.es/ecma262/#sec-object.isfrozen
	$$1a({ target: 'Object', stat: true, forced: FORCED$9 }, {
	...
	// `Object.keys` method
	// https://tc39.es/ecma262/#sec-object.keys
	$$19({ target: 'Object', stat: true, forced: FAILS_ON_PRIMITIVES$2 }, {
	...
	var FAILS_ON_PRIMITIVES$1 = fails$D(function () { $seal(1); });

	// `Object.seal` method
	// https://tc39.es/ecma262/#sec-object.seal
	$$18({ target: 'Object', stat: true, forced: FAILS_ON_PRIMITIVES$1, sham: !FREEZING$2 }, {
	  seal: function seal(it) {
	    return $seal && isObject$f(it) ? $seal(onFreeze$1(it)) : it;
	  }
	});
	...
	if (!TO_STRING_TAG_SUPPORT) {
	  defineBuiltIn$c(Object.prototype, 'toString', toString$l, { unsafe: true });
	}
	...
	var speciesConstructor$3 = function (O, defaultConstructor) {
	  ...
	  var S;
	  return C === undefined || isNullOrUndefined$7(S = anObject$x(C)[SPECIES$2]) ? defaultConstructor : aConstructor$2(S);
	};
	...
	if (!set$1 || !clear) {
	  ...
	  // IE8 has postMessage, but it's sync & typeof its postMessage is 'object'
	    ...
	    isCallable$e(globalThis$B.postMessage) &&
	...
	var safeGetBuiltIn$2 = function (name) {
	  if (!DESCRIPTORS$h) return globalThis$A[name];
	  var descriptor = getOwnPropertyDescriptor$4(globalThis$A, name);
	...
	var MutationObserver = globalThis$z.MutationObserver || globalThis$z.WebKitMutationObserver;
	var document$2 = globalThis$z.document;
	var process$1 = globalThis$z.process;
	var Promise$1 = globalThis$z.Promise;
	...
	if (!microtask$1) {
	  ...
	  // - setTimeout
	    ...
	    macrotask = bind$7(macrotask, globalThis$z);
	    notify$1 = function () {
	      macrotask(flush);
	    };
	  }
	...
	var promiseNativeConstructor = globalThis$y.Promise;
	...
	var NATIVE_PROMISE_REJECTION_EVENT$1 = isCallable$d(globalThis$x.PromiseRejectionEvent);
	...
	var process = globalThis$w.process;
	var newPromiseCapability$1 = newPromiseCapabilityModule$4.f;
	var newGenericPromiseCapability = newPromiseCapability$1;

	var DISPATCH_EVENT = !!(document$1 && document$1.createEvent && globalThis$w.dispatchEvent);
	...
	var isThenable = function (it) {
	  var then;
	  return isObject$e(it) && isCallable$c(then = it.then) ? then : false;
	};
	...
	var dispatchEvent = function (name, promise, reason) {
	  ...
	  if (DISPATCH_EVENT) {
	    ...
	    globalThis$w.dispatchEvent(event);
	  } else event = { promise: promise, reason: reason };
	  if (!NATIVE_PROMISE_REJECTION_EVENT && (handler = globalThis$w['on' + name])) handler(event);
	  else if (name === UNHANDLED_REJECTION) hostReportErrors('Unhandled promise rejection', reason);
	};

	var onUnhandled = function (state) {
	  call$v(task, globalThis$w, function () {
	...
	$$15({ target: 'Promise', stat: true, forced: PROMISE_STATICS_INCORRECT_ITERATION$2 }, {
	...
	$$10({ target: 'Promise', stat: true, forced: PROMISE_STATICS_INCORRECT_ITERATION }, {
	...
	$$$({ target: 'Promise', proto: true, real: true, forced: NON_GENERIC }, {
	  'finally': function (onFinally) {
	    var C = speciesConstructor$1(this, getBuiltIn$a('Promise'));
	...
	$$_({ target: 'Reflect', stat: true, forced: OPTIONAL_ARGUMENTS_LIST }, {
	  apply: function apply(target, thisArgument, argumentsList) {
	    return functionApply(aCallable$d(target), thisArgument, anObject$v(argumentsList));
	  }
	});
	...
	var nativeConstruct = getBuiltIn$9('Reflect', 'construct');
	...
	$$Z({ target: 'Reflect', stat: true, forced: FORCED$8, sham: FORCED$8 }, {
	  construct: function construct(Target, args /* , newTarget */) {
	    ...
	    if (Target === newTarget) {
	      ...
	      var $args = [null];
	      apply$5(push$a, $args, args);
	      return new (apply$5(bind$5, Target, $args))();
	    }
	    // with altered newTarget, not support built-in constructors
	    var proto = newTarget.prototype;
	    var instance = create$7(isObject$b(proto) ? proto : ObjectPrototype$1);
	...
	$$Y({ target: 'Reflect', stat: true, forced: ERROR_INSTEAD_OF_FALSE, sham: !DESCRIPTORS$g }, {
	...
	$$X({ target: 'Reflect', stat: true }, {
	  deleteProperty: function deleteProperty(target, propertyKey) {
	    var descriptor = getOwnPropertyDescriptor$3(anObject$s(target), propertyKey);
	...
	function get(target, propertyKey /* , receiver */) {
	  ...
	  if (isObject$a(prototype = getPrototypeOf$4(target))) return get(prototype, propertyKey, receiver);
	}
	...
	$$V({ target: 'Reflect', stat: true, sham: !CORRECT_PROTOTYPE_GETTER }, {
	  getPrototypeOf: function getPrototypeOf(target) {
	    return objectGetPrototypeOf(anObject$q(target));
	  }
	});
	...
	setToStringTag$4(globalThis$v.Reflect, 'Reflect', true);
	...
	var regexpGetFlags = function (R) {
	  var flags = R.flags;
	  return flags === undefined && !('flags' in RegExpPrototype$6) && !hasOwn$c(R, 'flags') && isPrototypeOf$4(RegExpPrototype$6, R)
	    ? call$p(regExpFlags$1, R) : flags;
	};
	...
	var SyntaxError$2 = globalThis$r.SyntaxError;
	var exec$7 = uncurryThis$C(RegExpPrototype$5.exec);
	  ...
	  for (; index <= length; index++) {
	    ...
	    if (chr === '\\') {
	      ...
	      case chr === '(':
	        ...
	        if (exec$7(IS_NCG, stringSlice$b(string, index + 1))) {
	          index += 2;
	          ncg = true;
	        }
	        groupid++;
	...
	$$Q({ target: 'RegExp', proto: true, forced: /./.exec !== exec$6 }, {
	  exec: exec$6
	});
	...
	var FORCED$7 = DESCRIPTORS$d && fails$s(function () {
	...
	// https://tc39.es/ecma262/#sec-get-regexp.prototype.flags
	if (FORCED$7) defineBuiltInAccessor$9(RegExpPrototype$3, 'flags', {
	  configurable: true,
	  get: regExpFlags
	});
	...
	$$P({ target: 'RegExp', proto: true, forced: !DELEGATES_TO_EXEC }, {
	  test: function (S) {
	    var R = anObject$n(this);
	    var string = toString$i(S);
	    var exec = R.exec;
	    if (!isCallable$9(exec)) return call$n(nativeTest, R, string);
	...
	var toIntegerOrInfinity$9 = toIntegerOrInfinity$k;
	...
	SetRecord.prototype = {
	  getIterator: function () {
	    return getIteratorDirect$a(anObject$l(call$l(this.keys, this.set)));
	  },
	...
	var toIntegerOrInfinity$8 = toIntegerOrInfinity$k;
	var toString$h = toString$v;
	var fails$p = fails$1g;

	var charAt$8 = uncurryThis$y(''.charAt);

	var FORCED$6 = fails$p(function () {
	...
	var slice$3 = uncurryThis$x(''.slice);
	var min$5 = Math.min;
	...
	$$F({ target: 'String', stat: true, arity: 1, forced: INCORRECT_LENGTH }, {
	  ...
	  fromCodePoint: function fromCodePoint(x) {
	    ...
	    while (length > i) {
	      code = +arguments[i++];
	      if (toAbsoluteIndex$2(code, 0x10FFFF) !== code) throw new $RangeError$5(code + ' is not a valid code point');
	...
	var uncurryThis$u = functionUncurryThis;
	var toIntegerOrInfinity$7 = toIntegerOrInfinity$k;
	...
	var fixRegexpWellKnownSymbolLogic = function (KEY, exec, FORCED, SHAM) {
	  ...
	  if (SHAM) createNonEnumerableProperty$7(RegExpPrototype[SYMBOL], 'sham', true);
	};
	...
	var regexpExecAbstract = function (R, S) {
	  ...
	  if (classof$6(R) === 'RegExp') return call$j(regexpExec, R, S);
	...
	fixRegExpWellKnownSymbolLogic$3('match', function (MATCH, nativeMatch, maybeCallNative) {
	  return [
	    ...
	    function match(regexp) {
	      ...
	      return matcher ? call$i(matcher, regexp, O) : new RegExp(regexp)[MATCH](toString$c(O));
	    },
	...
	var toIntegerOrInfinity$6 = toIntegerOrInfinity$k;
	...
	fixRegExpWellKnownSymbolLogic$2('replace', function (_, nativeReplace, maybeCallNative) {
	  ...
	  return [
	    ...
	    function replace(searchValue, replaceValue) {
	      ...
	      var replacer = isNullOrUndefined$5(searchValue) ? undefined : getMethod$4(searchValue, REPLACE$1);
	      return replacer
	        ? call$h(replacer, searchValue, O, replaceValue)
	        : call$h(nativeReplace, toString$a(O), searchValue, replaceValue);
	    },
	    ...
	    function (string, replaceValue) {
	      ...
	      for (var i = 0; i < results.length; i++) {
	        ...
	        if (functionalReplace) {
	          ...
	          replacement = toString$a(apply$4(replaceValue, undefined, replacerArgs));
	        } else {
	...
	fixRegExpWellKnownSymbolLogic$1('search', function (SEARCH, nativeSearch, maybeCallNative) {
	  return [
	    ...
	    function search(regexp) {
	      ...
	      return searcher ? call$g(searcher, regexp, O) : new RegExp(regexp)[SEARCH](toString$9(O));
	    },
	  ...
	  return [
	    ...
	    function split(separator, limit) {
	      ...
	      return splitter
	        ...
	        : call$f(internalSplit, toString$8(O), separator, limit);
	    },
	...
	$$B({ target: 'String', proto: true, forced: !MDN_POLYFILL_BUG && !CORRECT_IS_REGEXP_LOGIC }, {
	  startsWith: function startsWith(searchString /* , position = 0 */) {
	    var that = toString$7(requireObjectCoercible$2(this));
	...
	var createHtml = function (string, tag, attribute, value) {
	  var S = toString$6(requireObjectCoercible$1(string));
	  var p1 = '<' + tag;
	...
	$$z({ target: 'String', proto: true, forced: forcedStringHTMLMethod$4('anchor') }, {
	  anchor: function anchor(name) {
	    return createHTML$4(this, 'a', 'name', name);
	  }
	});
	...
	$$y({ target: 'String', proto: true, forced: forcedStringHTMLMethod$3('sub') }, {
	  sub: function sub() {
	    return createHTML$3(this, 'sub', '', '');
	  }
	});
	...
	var Int8Array$4 = globalThis$p.Int8Array;
	var Int8ArrayPrototype$1 = Int8Array$4 && Int8Array$4.prototype;
	var Uint8ClampedArray$1 = globalThis$p.Uint8ClampedArray;
	...
	var NATIVE_ARRAY_BUFFER_VIEWS$2 = NATIVE_ARRAY_BUFFER && !!setPrototypeOf$2 && classof$5(globalThis$p.opera) !== 'Opera';
	...
	var isView = function isView(it) {
	  ...
	  return klass === 'DataView'
	    || hasOwn$a(TypedArrayConstructorsList, klass)
	    || hasOwn$a(BigIntArrayConstructorsList, klass);
	};
	...
	var getTypedArrayConstructor$7 = function (it) {
	  ...
	  return (state && hasOwn$a(state, TYPED_ARRAY_CONSTRUCTOR)) ? state[TYPED_ARRAY_CONSTRUCTOR] : getTypedArrayConstructor$7(proto);
	};

	var isTypedArray$1 = function (it) {
	  if (!isObject$7(it)) return false;
	  var klass = classof$5(it);
	  return hasOwn$a(TypedArrayConstructorsList, klass)
	    || hasOwn$a(BigIntArrayConstructorsList, klass);
	};
	...
	var aTypedArrayConstructor$1 = function (C) {
	  if (isCallable$6(C) && (!setPrototypeOf$2 || isPrototypeOf$2(TypedArray$1, C))) return C;
	...
	var exportTypedArrayMethod$t = function (KEY, property, forced, options) {
	  ...
	  if (forced) for (var ARRAY in TypedArrayConstructorsList) {
	    var TypedArrayConstructor = globalThis$p[ARRAY];
	    if (TypedArrayConstructor && hasOwn$a(TypedArrayConstructor.prototype, KEY)) try {
	...
	var exportTypedArrayStaticMethod = function (KEY, property, forced) {
	  ...
	  if (setPrototypeOf$2) {
	    if (forced) for (ARRAY in TypedArrayConstructorsList) {
	      TypedArrayConstructor = globalThis$p[ARRAY];
	      if (TypedArrayConstructor && hasOwn$a(TypedArrayConstructor, KEY)) try {
	...
	if (!NATIVE_ARRAY_BUFFER_VIEWS$2 || !isCallable$6(TypedArray$1) || TypedArray$1 === Function.prototype) {
	  ...
	  if (NATIVE_ARRAY_BUFFER_VIEWS$2) for (NAME in TypedArrayConstructorsList) {
	    if (globalThis$p[NAME]) setPrototypeOf$2(globalThis$p[NAME], TypedArray$1);
	  }
	}
	...
	if (!NATIVE_ARRAY_BUFFER_VIEWS$2 || !TypedArrayPrototype$2 || TypedArrayPrototype$2 === ObjectPrototype) {
	  ...
	  if (NATIVE_ARRAY_BUFFER_VIEWS$2) for (NAME in TypedArrayConstructorsList) {
	    if (globalThis$p[NAME]) setPrototypeOf$2(globalThis$p[NAME].prototype, TypedArrayPrototype$2);
	  }
	}
	...
	if (DESCRIPTORS$b && !hasOwn$a(TypedArrayPrototype$2, TO_STRING_TAG$3)) {
	  ...
	  for (NAME in TypedArrayConstructorsList) if (globalThis$p[NAME]) {
	    createNonEnumerableProperty$6(globalThis$p[NAME], TYPED_ARRAY_TAG$1, NAME);
	  }
	}
	...
	var Int8Array$3 = globalThis$o.Int8Array;
	...
	var toIntegerOrInfinity$5 = toIntegerOrInfinity$k;
	...
	var RangeError$2 = globalThis$n.RangeError;
	...
	if (DESCRIPTORS$a) {
	  ...
	  typedArrayConstructor.exports = function (TYPE, wrapper, CLAMPED) {
	    ...
	    var GETTER = 'get' + TYPE;
	    var SETTER = 'set' + TYPE;
	    var NativeTypedArrayConstructor = globalThis$n[CONSTRUCTOR_NAME];
	    ...
	    if (!NATIVE_ARRAY_BUFFER_VIEWS) {
	      TypedArrayConstructor = wrapper(function (that, data, offset, $length) {
	        ...
	        if (!isObject$6(data)) {
	          ...
	          return call$d(typedArrayFrom, TypedArrayConstructor, data);
	        }
	...
	var toIntegerOrInfinity$4 = toIntegerOrInfinity$k;

	var aTypedArray$r = ArrayBufferViewCore$r.aTypedArray;
	var exportTypedArrayMethod$s = ArrayBufferViewCore$r.exportTypedArrayMethod;
	...
	var Uint8Array$1 = globalThis$m.Uint8Array;
	...
	var toIntegerOrInfinity$3 = toIntegerOrInfinity$k;
	...
	var arrayLastIndexOf = FORCED$5 ? function lastIndexOf(searchElement /* , fromIndex = @[*-1] */) {
	  ...
	  var index = length - 1;
	  if (arguments.length > 1) index = min(index, toIntegerOrInfinity$3(arguments[1]));
	...
	var getTypedArrayConstructor$5 = ArrayBufferViewCore$c.getTypedArrayConstructor;
	...
	var Int8Array$2 = globalThis$l.Int8Array;
	...
	var TO_OBJECT_BUG = WORKS_WITH_OBJECTS_AND_GENERIC_ON_TYPED_ARRAYS && ArrayBufferViewCore$8.NATIVE_ARRAY_BUFFER_VIEWS && fails$g(function () {
	...
	var Uint16Array = globalThis$k.Uint16Array;
	...
	var Int8Array$1 = globalThis$j.Int8Array;
	...
	var Uint8Array = globalThis$i.Uint8Array;
	...
	var toIntegerOrInfinity$2 = toIntegerOrInfinity$k;
	...
	var toIntegerOrInfinity$1 = toIntegerOrInfinity$k;
	...
	var hasMSEdgeFreezingBug = function () {
	  return FREEZING$1 && fails$b(function () {
	...
	var addToUnscopables = addToUnscopables$c;
	...
	var NativeIterator = globalThis$g[ITERATOR$3];
	...
	$$v({ global: true, constructor: true, forced: FORCED$2 }, {
	  ...
	  return defineBuiltIns$1(create$3(IteratorPrototype), {
	    ...
	    'return': function () {
	      ...
	      if (IS_ITERATOR) {
	        ...
	        return returnMethod ? call$a(returnMethod, iterator) : createIterResultObject$1(undefined, true);
	      }
	      if (state.inner) try {
	...
	createNonEnumerableProperty$4(IteratorHelperPrototype, TO_STRING_TAG$1, 'Iterator Helper');
	...
	var IteratorProxy$2 = createIteratorProxy$2(function () {
	  ...
	  while (true) {
	    result = anObject$c(call$9(next, iterator));
	...
	var getIteratorFlattenable$1 = function (obj, stringHandling) {
	  ...
	  return getIteratorDirect$6(anObject$a(method !== undefined ? call$8(method, obj) : obj));
	};
	...
	var IteratorProxy$1 = createIteratorProxy$1(function () {
	  ...
	  while (true) {
	    if (inner = this.inner) try {
	      result = anObject$9(call$7(inner.next, inner.iterator));
	      if (!result.done) return result.value;
	      this.inner = null;
	    } catch (error) { iteratorClose(iterator, 'throw', error); }

	    result = anObject$9(call$7(this.next, iterator));
	...
	$$m({ target: 'Iterator', proto: true, real: true }, {
	  toArray: function toArray() {
	    var result = [];
	    iterate$1(getIteratorDirect(anObject$4(this)), push$6, { that: result, IS_RECORD: true });
	    return result;
	  }
	});
	...
	var JSON$1 = globalThis$f.JSON;
	var Number$1 = globalThis$f.Number;
	...
	var exec$3 = uncurryThis$b(disallowed.exec);

	var BASIC$1 = !!$atob && !fails$8(function () {
	  return $atob('aGk=') !== 'hi';
	});

	var NO_SPACES_IGNORE = BASIC$1 && fails$8(function () {
	  return $atob(' ') !== '';
	});

	var NO_ENCODING_CHECK = BASIC$1 && !fails$8(function () {
	  $atob('a');
	});

	var NO_ARG_RECEIVING_CHECK$1 = BASIC$1 && !fails$8(function () {
	  $atob();
	});

	var WRONG_ARITY$2 = BASIC$1 && $atob.length !== 1;

	var FORCED$1 = !BASIC$1 || NO_SPACES_IGNORE || NO_ENCODING_CHECK || NO_ARG_RECEIVING_CHECK$1 || WRONG_ARITY$2;

	// `atob` method
	// https://html.spec.whatwg.org/multipage/webappapis.html#dom-atob
	$$k({ global: true, bind: true, enumerable: true, forced: FORCED$1 }, {
	  atob: function atob(data) {
	    validateArgumentsLength$7(arguments.length, 1);
	    // `webpack` dev server bug on IE global methods - use call(fn, global, ...)
	    if (BASIC$1 && !NO_SPACES_IGNORE && !NO_ENCODING_CHECK) return call$4($atob, globalThis$e, data);
	...
	var BASIC = !!$btoa && !fails$7(function () {
	  return $btoa('hi') !== 'aGk=';
	});

	var NO_ARG_RECEIVING_CHECK = BASIC && !fails$7(function () {
	  $btoa();
	});

	var WRONG_ARG_CONVERSION = BASIC && fails$7(function () {
	...
	$$j({ global: true, bind: true, enumerable: true, forced: !BASIC || NO_ARG_RECEIVING_CHECK || WRONG_ARG_CONVERSION || WRONG_ARITY$1 }, {
	  btoa: function btoa(data) {
	    validateArgumentsLength$6(arguments.length, 1);
	    // `webpack` dev server bug on IE global methods - use call(fn, global, ...)
	    if (BASIC) return call$3($btoa, globalThis$d, toString$3(data));
	...
	for (var COLLECTION_NAME in DOMIterables) {
	  handlePrototype(globalThis$b[COLLECTION_NAME] && globalThis$b[COLLECTION_NAME].prototype, COLLECTION_NAME);
	}
	...
	var NativeDOMException$1 = getBuiltIn$4(DOM_EXCEPTION$2) || (function () {
	  try {
	    ...
	    var MessageChannel = getBuiltIn$4('MessageChannel') || getBuiltInNodeModule('worker_threads').MessageChannel;
	...
	// eslint-disable-next-line es/no-object-getownpropertydescriptor -- safe
	var descriptor$1 = NativeDOMException && DESCRIPTORS$5 && Object.getOwnPropertyDescriptor(globalThis$a, DOM_EXCEPTION$1);
	...
	$$g({ global: true, bind: true, enumerable: true, forced: globalThis$9.clearImmediate !== clearImmediate }, {
	...
	// https://github.com/oven-sh/bun/issues/1633
	var setImmediate = globalThis$7.setImmediate ? schedulersFix(setTask, false) : setTask;

	// `setImmediate` method
	// http://w3c.github.io/setImmediate/#si-setImmediate
	$$f({ global: true, bind: true, enumerable: true, forced: globalThis$7.setImmediate !== setImmediate }, {
	    ...
	    if (INCORRECT_VALUE || !descriptor || !descriptor.get || !descriptor.enumerable) {
	      defineBuiltInAccessor$3(globalThis$6, 'self', {
	        ...
	        set: function self(value) {
	          if (this !== globalThis$6) throw new $TypeError$1('Illegal invocation');
	...
	var thisTimeValue = uncurryThis$8(Date$1.prototype.getTime);
	...
	var cloneBuffer = function (value, map, $type) {
	  ...
	  if (type === 'SharedArrayBuffer') {
	    ...
	    if (!DataView && !isCallable$2(value.slice)) throwUnpolyfillable('ArrayBuffer');
	    // detached buffers throws in `DataView` and `.slice`
	    try {
	      if (isCallable$2(value.slice) && !value.resizable) {
	        clone = value.slice(0);
	      } else {
	...
	var structuredCloneInternal = function (value, map) {
	  ...
	  switch (type) {
	    ...
	    case 'RegExp':
	      ...
	      cloned = new RegExp(value.source, getRegExpFlags$1(value));
	      break;
	    case 'Error':
	      name = value.name;
	      switch (name) {
	  ...
	  switch (type) {
	    ...
	    case 'Set':
	      ...
	      break;
	    case 'Error':
	      createNonEnumerableProperty$1(cloned, 'message', structuredCloneInternal(value.message, map));
	      if (hasOwn$2(value, 'cause')) {
	        createNonEnumerableProperty$1(cloned, 'cause', structuredCloneInternal(value.cause, map));
	      }
	    ...
	    case 'DOMException':
	      if (ERROR_STACK_INSTALLABLE) {
	        createNonEnumerableProperty$1(cloned, 'stack', structuredCloneInternal(value.stack, map));
	      }
	  }
	...
	var detachBuffers = function (buffers) {
	  setIterate(buffers, function (buffer) {
	    ...
	    } else if (isCallable$2(buffer.transfer)) {
	      buffer.transfer();
	...
	$$d({ global: true, enumerable: true, sham: !PROPER_STRUCTURED_CLONE_TRANSFER, forced: FORCED_REPLACEMENT }, {
	  structuredClone: function structuredClone(value /* , { transfer } */) {
	    var options = validateArgumentsLength$4(arguments.length, 1) > 1 && !isNullOrUndefined$1(arguments[1]) ? anObject$1(arguments[1]) : undefined;
	...
	var urlConstructorDetection = !fails$3(function () {
	  ...
	  return (IS_PURE$1 && (!url.toJSON || !params2.has('a', 1) || params2.has('a', 2) || !params2.has('a', undefined) || params2.has('b')))
	    || (!params.size && (IS_PURE$1 || !DESCRIPTORS$3))
	    || !params.sort
	...
	var exec$2 = uncurryThis$7(regexSeparators.exec);
	...
	$$b({ global: true, constructor: true, forced: !USE_NATIVE_URL, sham: !DESCRIPTORS$1 }, {
	  URL: URLConstructor
	});
	...
	// `URL.prototype.toJSON` method
	// https://url.spec.whatwg.org/#dom-url-tojson
	$$a({ target: 'URL', proto: true, enumerable: true }, {
	...
	var toIntegerOrInfinity = toIntegerOrInfinity$k;
	...
	var nativeToExponential = uncurryThis$1(1.0.toExponential);
	...
	$$7({ target: 'String', proto: true, forced: forcedStringHTMLMethod$2('bold') }, {
	  bold: function bold() {
	    return createHTML$2(this, 'b', '', '');
	  }
	});
	...
	$$6({ target: 'String', proto: true, forced: forcedStringHTMLMethod$1('italics') }, {
	...
	$$5({ target: 'String', proto: true, forced: forcedStringHTMLMethod('strike') }, {
	...
	var globalIsFinite = globalThis$2.isFinite;
	...
	// `Number.isFinite` method
	// https://tc39.es/ecma262/#sec-number.isfinite
	$$4({ target: 'Number', stat: true }, { isFinite: numberIsFinite });
