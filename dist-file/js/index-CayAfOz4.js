import { d as defineComponent, r as ref, v as onMounted, o as openBlock, c as createElementBlock, x as withDirectives, a as createBaseVNode, q as i18n, a8 as resolveDirective } from "./index-DasOlK5F.js";
const decodeCache = {};
...
const _hoisted_1 = { class: "w-3/4 mb-10 ml-3" };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function readMd() {
      fetch("/log-lottery/".concat(i18n.global.t("data.readmeName"))).then((res) => res.text()).then((res) => {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        withDirectives(createBaseVNode("div", _hoisted_2, null, 512), [
          [_directive_dompurify_html, readmeHtml.value]
        ])
      ]);
    };
  }
